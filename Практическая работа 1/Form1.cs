    ...
    public partial class Form1 : Form
    {
        ...
        private void оПрограммеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Практическая работа №1\n" +
                ...
                "Программа находит минимальное число из указанного количества чисел в диапазоне от 10 до 40 и выводит эти числа и их минимальное в соответствующие поля");
        }
